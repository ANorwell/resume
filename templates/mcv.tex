...
\section{\textbf{Skills}}
      ...
      \cvlistdoubleitem{Distributed Systems (ZeroMQ, Zookeeper)}
                       {Cloud Applications (AWS, S3, OpenStack)}
...
%\subsection{\textbf{Languages}}
  ...
  \cvline{Languages}{Java, Scala, C, C++, Ruby, Javascript, Perl, Python, elisp, Go, R}
  

\section{\textbf{Experience}}

  \cventry{Nov 2013 - Present}{\textbf{Senior Software Engineer}}{Datto}{}{Boston, MA}
